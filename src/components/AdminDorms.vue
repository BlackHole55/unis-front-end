              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="card-footer d-flex">
                    ...
                    <a class="btn" id="btn" :href="'/admin/dorms/' + dorm.id + '/update'">Өңдеу</a>
                    <div class="card-text pt-2 ms-3" v-if="dorm.price_tenge">{{ dorm.price_tenge }} KZT</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row mt-3">
        ...
        <div class="col-lg-8">
          <div class="d-flex justify-content-between">
            ...
            <div class="pt-2" id="currentPage"><strong>{{ getDorms?.dorms?.current_page }} - {{ getSearchedUniversities?.universities?.last_page }}</strong></div>
